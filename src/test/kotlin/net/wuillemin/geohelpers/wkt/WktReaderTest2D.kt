...
class WktReaderTest2D {
    ...
    fun testLineString() {
        ...
        val lineStringFile = File(javaClass.classLoader.getResource("wkt\\2d\\linestring.txt").toURI()).inputStream()
    ...
    fun testPolygon() {
        ...
        val polygonFile = File(javaClass.classLoader.getResource("wkt\\2d\\polygon.txt").toURI()).inputStream()
    ...
    fun testMultiPoint() {
        ...
        val multiPointFile = File(javaClass.classLoader.getResource("wkt\\2d\\multipoint.txt").toURI()).inputStream()
    ...
    fun testMultiLineString() {
        ...
        val multiLineStringFile = File(javaClass.classLoader.getResource("wkt\\2d\\multilinestring.txt").toURI()).inputStream()
    ...
    fun testMultiPolygon() {
        ...
        val multiPolygonFile = File(javaClass.classLoader.getResource("wkt\\2d\\multipolygon.txt").toURI()).inputStream()
