...
class WktReaderTest3D {
    ...
    fun testPoint() {
        ...
        // POINT (30 10)
        val pointFile = File(javaClass.classLoader.getResource("wkt\\3d\\point.txt").toURI()).inputStream()
    ...
    fun testLineString() {
        ...
        val lineStringFile = File(javaClass.classLoader.getResource("wkt\\3d\\linestring.txt").toURI()).inputStream()
    ...
    fun testPolygon() {
        ...
        val polygonFile = File(javaClass.classLoader.getResource("wkt\\3d\\polygon.txt").toURI()).inputStream()
    ...
    fun testMultiPoint() {
        ...
        val multiPointFile = File(javaClass.classLoader.getResource("wkt\\3d\\multipoint.txt").toURI()).inputStream()
    ...
    fun testMultiLineString() {
        ...
        val multiLineStringFile = File(javaClass.classLoader.getResource("wkt\\3d\\multilinestring.txt").toURI()).inputStream()
    ...
    fun testMultiPolygon() {
        ...
        val multiPolygonFile = File(javaClass.classLoader.getResource("wkt\\3d\\multipolygon.txt").toURI()).inputStream()
